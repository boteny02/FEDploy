    ...
    <ul class="nav pcoded-inner-navbar">
        ...
        <li class="nav-item pcoded-hasmenu {{ Request::is('admin/web*') ? 'pcoded-trigger active' : '' }}">
            ...
            <ul class="pcoded-submenu">
                ...
                @can('admission-action-view')
                <li class="{{ Request::is('admin/web/admission-action*') ? 'active' : '' }}"><a href="{{ route('admin.admission-action.index') }}" class="">{{ trans_choice('module_admission_action', 1) }}</a></li>
                @endcan
            </ul>
        </li>
        @endcanany
