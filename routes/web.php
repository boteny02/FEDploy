...
Route::middleware(['auth:web', 'XSS', 'license'])->name('admin.')->namespace('Admin')->prefix('admin')->group(function () {
    ...
    Route::prefix('web')->namespace('Web')->group(function () {
        ...
        Route::resource('admission-action', 'AdmissionActionController');

        // New Admission Registration Routes
        // Route::resource('new-admission', 'NewAdmissionController');
    });
});
...
Route::prefix('student')->name('student.')->namespace('Student')->group(function () {
    ...
    Route::namespace('Auth')->group(function () {
        ...
        Route::post('/register', 'RegisterController@register')->name('register.store')->middleware('admission');
        ...
        // no admission route
        Route::get('/no-admission', function () {
            return view('errors.no-admission');
        })->name('no.admission');
    });
});
